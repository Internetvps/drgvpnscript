...
patchtls=/drgvpn-vmesswstls
patchnontls=/drgvpn-vmesswsntls
...
patchtls=/drgvpn-vlesswstls
patchnontls=/drgvpn-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
read -p "   Expired (days) : " masaaktif
...
patchtls=/drgvpn-trojanwstls
patchnone=drgvpn-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address

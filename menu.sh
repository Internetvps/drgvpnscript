...
echo -e " \e[$line***************************************************************\e[m"
echo -e " \e[$number  •1\e[m \e[$below •XRAY VMESS & VLESS\e[m           \e[$number •7\e[m \e[$below •REBOOT NOW VPS\e[m"
echo -e "  \e[$number •2\e[m \e[$below •TROJAN XRAY & WS\e[m             \e[$number •8\e[m \e[$below •CHANGE THEMES\e[m"
echo -e "  \e[$number •3\e[m \e[$below •SSH & OPENVPN\e[m                \e[$number •9\e[m \e[$below •ADD IP\e[m"
echo -e "  \e[$number •4\e[m \e[$below •SYSTEM MENU\e[m                  \e[$number •10\e[m \e[$below•INFO\e[m"
echo -e "  \e[$number •5\e[m \e[$below •CHECK RUNNING\e[m                \e[$number •11\e[m \e[$below•CLEAR LOG\e[m"
echo -e "  \e[$number •6\e[m \e[$below •CHANGE PORT\e[m                  \e[$number •12\e[m \e[$below•EXIT\e[m"
echo -e " \e[$line*************************************************************\e[m"
